 ...
 *******************************************************************************
 *Name of program**************************************************************/
   %iniprog(name = it_14_2_os_subgr);
/*
 * Purpose          : Table 9-28 Subgroup analysis of OS by histology according to investigator pathology (FAS)
 * Programming Spec :
...
data mzl;
    set tlfmeta.t_14_2_adtte_os_hist_1
        tlfmeta.t_14_2_adtte_os_hist_2
        tlfmeta.t_14_2_adtte_os_hist_3
        tlfmeta.t_14_2_adtte_os_hist_4
        tlfmeta.t_14_2_adtte_os_submzl_1(in=a)
        tlfmeta.t_14_2_adtte_os_submzl_2(in=a)
        tlfmeta.t_14_2_adtte_os_submzl_3(in=a)
     ;
        format text vartxt  chck varl $200. ;
    ...
    *pla;
    ...
    %m_itmtitle(
      ...
      , title     =%nrbquote(Table 9-21 Subgroup analysis of OS by histology according to investigator pathology (FAS))
      ,keepftn=Y
      ,evaltable =
    )
